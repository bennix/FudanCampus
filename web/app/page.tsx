...
const views:{name:string;p:number[];t:number[];fov?:number}[]=[
 ...
 {name:'化学楼',p:[-95.6,3,-137.8],t:[-97.6,6,-155.8],fov:68},
...
export default function Home(){
 ...
 Promise.all([new GLTFLoader().loadAsync('/campus.glb?v=map-v14-office'),fetch('/buildings.json?v=map-v14-office',{signal:abort.signal}).then(r=>{if(!r.ok)throw Error('标签文件不可用');return r.json() as Promise<{buildings:Building[]}>;})]).then(([g,data])=>{
